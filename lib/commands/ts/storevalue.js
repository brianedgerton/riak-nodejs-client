...
var columnTypeByValue = Object.freeze({
    0: TsColumnType.BINARY,
    1: TsColumnType.INTEGER,
    2: TsColumnType.NUMERIC,
    3: TsColumnType.TIMESTAMP,
    4: TsColumnType.BOOLEAN,
    5: TsColumnType.SET,
    6: TsColumnType.MAP
});
...
StoreValue.prototype.constructPbRequest = function() {
    ...
    if (this.options.columns) {
        ...
        for (i = 0; i < this.options.columns.length; i++) {
            ...
            ct = col.type;
            columnTypes.push(ct);
            tscd.setType(columnTypeByValue[ct]);
...
var columnTypeSchema = Joi.number().valid(validColumnTypes);
...
module.exports.ColumnTypes = ColumnTypes;
